...
# স্মার্ট অ্যানালাইসিস লজিক
def analyze_message(text):
    text_lower = text.lower()
    neg = ["bad", "hate", "ugly", "stupid", "fuck", "sad"]
    pos = ["love", "happy", "great", "nice", "good"]
    
    if any(w in text_lower for w in neg):
        return {"emotion": "Angry/Sad 😡", "toxicity": "Toxic 🔴", "category": "Sensitive", "urgency": "High 🚨"}
    elif any(w in text_lower for w in pos):
        return {"emotion": "Happy 😊", "toxicity": "Safe 🟢", "category": "Social", "urgency": "Low 🟢"}
